...
class AIAgentWebStack(Stack):
    """
    AI Agent Web UI Stack
    Builds and deploys the React web UI for Agent A's multi-turn conversation interface
    """
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        repo = ecr.Repository(
            self,
            "AIAgentWebRepo",
            repository_name="ai-agent-web",  # lowercase, as required by ECR
        ...
        CfnOutput(
            ...
            description="ECR Image URI with custom tag (ai-agent-web:latest or ai-agent-web:vX.Y.Z)",
        )
