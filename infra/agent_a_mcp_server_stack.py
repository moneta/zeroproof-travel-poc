...
class AgentAMCPServerStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        repo = ecr.Repository(
            self,
            "AgentAMCPServerRepo",
            repository_name="agent-a-mcps",  # lowercase, as required by ECR
        ...
        docker_image = ecr_assets.DockerImageAsset(
            self,
            "AgentAMCPServerImage",
            directory="..",
            file="agent-a/mcp-server/Dockerfile",
        ...
        CfnOutput(
            ...
            description="ECR Image URI with custom tag (agent-a-mcps:latest or agent-a-mcps:vX.Y.Z)",
        )
